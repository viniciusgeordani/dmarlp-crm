      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="mt-10">
            <Link 
              to="/crm" 
              className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-6 py-3 rounded-lg border border-white/20 transition-all font-medium tracking-wide text-sm"
            >
